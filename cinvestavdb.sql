...
CREATE TABLE `evaluations` (
  ...
  `key_words` int(11) NOT NULL,
  `abstract_keywords` int(11) NOT NULL,
  `problematic` int(11) NOT NULL,
  `theoretical` int(11) NOT NULL,
  `methodology` int(11) NOT NULL,
  `proposal` int(11) NOT NULL,
  `results` int(11) NOT NULL,
  `APA_table` int(11) NOT NULL,
  `APA_references` int(11) NOT NULL,
  ...
  KEY `evaluations_project_id_foreign` (`project_id`),
  CONSTRAINT `evaluations_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`),
