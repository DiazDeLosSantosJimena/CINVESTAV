        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 my-3">
                        <p><strong>Nombre del postulante:</strong><br>
                            {{ $proyect->user->name . ' ' . $proyect->user->app . ' ' . $proyect->user->apm }}</p>
                    </div>
                    <div class="col-md-6 col-sm-12 my-3">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="row">
                    ...
                    @endif
                    <div class="col-md-12 col-sm-12 my-3">
                        <p><strong>Institución de procedencia:</strong><br> {{ $proyect->projects->sending_institution }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    @foreach ($files as $file)
                        <div class="col-auto mb-3 text-center">
                            <!-- Button Chip -->
                            <a href="{{ route('proyectos.download', $file->id) }}" type="button" class="mdl-chip"
                                style="background-color: #0178a0; color: white;">
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <form action="{{ route('evaluacion.store') }}" method="POST">
                                @csrf
                                <input type="hidden" value="{{ $proyect->user->id }}" name="user_id">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <input type="hidden" id="sumaTotal" name="sumaTotal" value="">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <div class="criterios" role="alert">
                                                Considerando los rangos anteriores, seleccione según su criterio; el
                                                producto propuesto debe ser: *
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;">
                                            <div class="criterios2"
                                                style="align-items: center; justify-content: center; display:flex;"
                                                role="alert">
                                                <input class="form-check-input custom-radio" type="radio"
                                                    name="criterio" value="A">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="criterios2" role="alert">
                                                El trabajo cumple con los estandares y formatos establecidos en la
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;">
                                            <div class="criterios2"
                                                ...
                                                role="alert">
                                                <input class="form-check-input custom-radio" type="radio"
                                                    name="criterio" value="AC">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="criterios2" role="alert">
                                                El trabajo será aceptado siempre y cuando se realizen las modificaciones
                                                solicitadas
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;">
                                            <div class="criterios2"
                                                ...
                                                role="alert">
                                                <input class="form-check-input custom-radio" type="radio"
                                                    name="criterio" value="R">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="criterios2" role="alert">
                                                El trabajo no cumple con los estandares y formatos establecidos en la
                                                convocatoria del congreso
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <td colspan="3">
                                        <textarea class="form-control" placeholder="Deje su comentario aqui" id="comentario" style="height: 100px"
