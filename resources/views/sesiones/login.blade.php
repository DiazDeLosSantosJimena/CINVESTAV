            ...
            <div class="col">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="email" id="email" value="{{old('email')}}" placeholder="Correo" required>
                        @error('email')
                        ...
                        <div class="my-3">
                            <span><a href="/register">Registrarse</a>/<a href="">Recuperar Contraseña</a></span>
                        </div>
                        <br>
                        <div class="d-grid">
