...
class ProposalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            ...
            'archive.required' => 'Suba el archivo requerido.',
            'rama_id.required' => 'Seleccione al menos 1 categoría al que pertenezca el proyecto',
        ];
        ...
        $request->validate([
            ...
            'rama_id' => ['required', 'integer', 'exists:' . Rama::class . ',id'],], $messages);
        ...
        return redirect()->route('proposals.index')->with('status', 'Proyecto registrado.');
    }
    ...
    public function show($id): View
    {
        ...
        return view('evaluacion.evaluacion', compact('proposal'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('proyectos.edit', compact('proposal', 'ramas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('proposals.index')->with('status', 'Proyecto Actualizado.');
    }
